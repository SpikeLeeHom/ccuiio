...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PotatsoModel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12PotatsoModel9BaseModel")
...
@interface ConfigurationGroup : BaseModel
@property (nonatomic) BOOL editable;
@property (nonatomic, copy) NSString * _Nonnull name;
@property (nonatomic) BOOL defaultToProxy;
@property (nonatomic, copy) NSString * _Nonnull dns;
...
SWIFT_CLASS("_TtC12PotatsoModel12ProxyRuleSet")
@interface ProxyRuleSet : BaseModel
@property (nonatomic) BOOL editable;
@property (nonatomic, copy) NSString * _Nonnull name;
@property (nonatomic) NSTimeInterval remoteUpdatedAt;
@property (nonatomic, copy) NSString * _Nonnull desc;
@property (nonatomic) NSInteger ruleCount;
